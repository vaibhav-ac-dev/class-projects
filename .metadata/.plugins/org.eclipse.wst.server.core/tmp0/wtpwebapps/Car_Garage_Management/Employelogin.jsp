...
<div class="input-box">
<input type="text" name="username" value="" placeholder="Username" required ><i class="fa-solid fa-user"></i>
</div>
<div class="input-box">
<input type="Password" name="password" value="" placeholder="Password " required autofill="off">
